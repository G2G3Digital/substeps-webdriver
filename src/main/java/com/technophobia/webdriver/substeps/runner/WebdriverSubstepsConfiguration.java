...
//    private static int smtpServerPort = 7191;
    ...
    static {
    	...
    	final URL defaultURL = WebdriverSubstepsConfiguration.class.getResource("/default-webdriver-substeps.properties");
...
//        props = initTestProperties();
        ...
        BASE_URL = removeTrailingSlash(Configuration.INSTANCE.getString("base.url"));
        ...
        VISUAL_WEBDRIVER_CLOSE_ON_FAIL = Configuration.INSTANCE.getBoolean(
                "visual.webdriver.close.on.fail");
...
//        final String smptpPortString = Configuration.INSTANCE.getString("smtp.port");
...
//    }
    ...
    private static Properties initTestProperties() {
        ...
        try {
            tempProps.load(WebdriverSubstepsConfiguration.class.getResourceAsStream(resourceBundleName));
