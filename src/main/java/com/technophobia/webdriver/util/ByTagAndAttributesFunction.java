 ...
 * 
 */
public class ByTagAndAttributesFunction implements Function<WebDriver, WebElement> {
    private final String tag;
    private final String attributeString;
    private final Map<String, String> expectedAttributes;


    public ByTagAndAttributesFunction(final String tag, final String attributeString) {
        this.tag = tag;
    ...
    public WebElement apply(final WebDriver driver) {
        ...
        final List<WebElement> elems = driver.findElements(By.tagName(tag));
